...
class simple_siamese(nn.Module):
    def __init__(self, config):
        ...
        self.conv3 = nn.Sequential(
                    nn.Conv2d(64, 32,  kernel_size = self.kernel_sizes3), # input (#batch, 768, num_para->30, num_words->50) # kernal size = 10  # output: (#batch, 128, 30, 40)
            nn.ReLU(inplace=True),
            nn.MaxPool2d((2,2), padding=0),
            nn.ReLU()
        )
        ...
        linear_size = 64
        self.fc1 = nn.Linear(160, linear_size)
